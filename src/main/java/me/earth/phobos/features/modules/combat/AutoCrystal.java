...
public class AutoCrystal extends Module
{
    ...
    public AutoCrystal() {
        ...
        this.placeRange = (Setting<Float>)this.register(new Setting("PlaceRange", 4.7f, 0.0f, 10.0f, v -> this.setting.getValue() == Settings.PLACE && this.place.getValue()));
        this.minDamage = (Setting<Float>)this.register(new Setting("MinDamage", 3.7f, 0.1f, 20.0f, v -> this.setting.getValue() == Settings.PLACE && this.place.getValue()));
        ...
        this.facePlace = (Setting<Float>)this.register(new Setting("FacePlace", 7.1f, 0.1f, 20.0f, v -> this.setting.getValue() == Settings.PLACE && this.place.getValue()));
        this.placetrace = (Setting<Float>)this.register(new Setting("Placetrace", 5.7f, 0.0f, 10.0f, v -> this.setting.getValue() == Settings.PLACE && this.place.getValue() && this.raytrace.getValue() != Raytrace.NONE && this.raytrace.getValue() != Raytrace.BREAK));
        ...
        this.breakRange = (Setting<Float>)this.register(new Setting("BreakRange", 4.7f, 0.0f, 10.0f, v -> this.setting.getValue() == Settings.BREAK && this.explode.getValue()));
        ...
        this.sync = (Setting<Boolean>)this.register(new Setting("Sync", false, v -> this.setting.getValue() == Settings.BREAK && (this.explode.getValue() || this.manual.getValue())));
        ...
        this.green = (Setting<Integer>)this.register(new Setting("Green", 0, 0, 255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue()));
        this.blue = (Setting<Integer>)this.register(new Setting("Blue", 0, 0, 255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue()));
        this.alpha = (Setting<Integer>)this.register(new Setting("Alpha", 170, 0, 255, v -> this.setting.getValue() == Settings.RENDER && this.render.getValue()));
        ...
        this.targetMode = (Setting<Target>)this.register(new Setting("Target", Target.DAMAGE, v -> this.setting.getValue() == Settings.MISC));
        ...
        this.damageSyncTime = (Setting<Integer>)this.register(new Setting("SyncDelay", 400, 0, 1000, v -> this.setting.getValue() == Settings.DEV && this.damageSync.getValue() != DamageSync.NONE));
        ...
        this.fullSync = (Setting<Boolean>)this.register(new Setting("FullSync", true, v -> this.setting.getValue() == Settings.DEV && this.damageSync.getValue() != DamageSync.NONE && this.syncedFeetPlace.getValue()));
        ...
        this.hyperSync = (Setting<Boolean>)this.register(new Setting("HyperSync", true, v -> this.setting.getValue() == Settings.DEV && this.damageSync.getValue() != DamageSync.NONE && this.syncedFeetPlace.getValue()));
        ...
        this.eventMode = (Setting<Integer>)this.register(new Setting("Updates", 2, 1, 3, v -> this.setting.getValue() == Settings.DEV));
                ...
                if (AutoCrystal.placedPos.contains(pos.down())) {
                    if (this.predictFriendDmg.getValue() && (this.antiFriendPop.getValue() == AntiFriendPop.BREAK || this.antiFriendPop.getValue() == AntiFriendPop.ALL)) {
                        for (final EntityPlayer friend : AutoCrystal.mc.world.playerEntities) {
                            if (friend != null && !AutoCrystal.mc.player.equals((Object)friend) && friend.getDistanceSq(pos) <= MathUtil.square(this.range.getValue() + this.placeRange.getValue())) {
                                if (!Phobos.friendManager.isFriend(friend)) {
                                    continue;
                                }
                ...
                if (this.syncedFeetPlace.getValue() && crystal.getPosition().down().equals((Object)this.syncedCrystalPos) && this.damageSync.getValue() != DamageSync.NONE) {
                    ...
                    if (DamageUtil.canTakeDamage(this.suicide.getValue())) {
                        if (this.altPosition.getValue()) {
                            selfDamage = DamageUtil.calculateDamageAlt(crystal, (Entity)AutoCrystal.mc.player);
                        }
                        else {
                            selfDamage = DamageUtil.calculateDamage(crystal, (Entity)AutoCrystal.mc.player);
                        }
                    }
